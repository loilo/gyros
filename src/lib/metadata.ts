...
import type { Context, AstNode } from '../gyros.js'
...
export const finishedNodes = new WeakSet<AstNode>()
 ...
 *
 */
export function checkNode(node: AstNode) {
 ...
 */
export const nodeMetadataStore = new WeakMap<AstNode, NodeMetadata>()
